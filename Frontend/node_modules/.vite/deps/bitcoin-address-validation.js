...
var normalizeAddressInfo = (addressInfo, options) => {
  return {
    ...addressInfo,
    network: castTestnetTo(addressInfo.network, options == null ? void 0 : options.castTestnetTo)
  };
};
...
var validate = (address, network, options) => {
  try {
...
//# sourceMappingURL=bitcoin-address-validation.js.map
